...
definition <- c("Size of the health system total population, which is used to calculate numbers of patients by age in the population",
                ...
                "Decrease in clinical events including non-fatal myocardial infarction (MI), stent thrombosis, revascularization after coronary artery bypass grafting (CABG), revascularization after percutaneous cornary intervention (PCI), compared to usual care",
