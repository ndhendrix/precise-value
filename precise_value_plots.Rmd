...
```{r}
numericInput(inputId = "pop_size", label = "Population size:",
            value = 250000)
numericInput(inputId = "p_w", label = "Percentage White:",
            value = 60)
numericInput(inputId = "p_l", label = "Percentage Latinx:",
            value = 18)
numericInput(inputId = "p_b", label = "Percentage Black:",
            value = 13)
numericInput(inputId = "p_l", label = "Percentage Asian:",
            value = 6)
numericInput(inputId = "p_o", label = "Percentage Other:",
            value = 3)
sliderInput(inputId = "t_horizon", label = "Time Horizon:",
            min = 5, max = 85, value = 20, step = 1)
sliderInput(inputId = "startup_cost", label = "Startup Cost:",
            min = 100, max = 20000, value = 4000, step = 100)
sliderInput(inputId = "maint_cost", label = "Maintenance Cost:",
